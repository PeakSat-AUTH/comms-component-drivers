...
enum class EnergyDetectionTimeBasis {
	RF_2MS = 0x0, RF_8MS = 0x1, RF_32MS = 0x2, RF_128MS = 0x3,
};
...
enum class PLLState {
	PLLNotLocked = 0x0, PLLLocked = 0x1
};
...
enum class SynchronizationFailure {
	NO_SYNCH_FAILURE, SYNCH_FAILURE
};
...
enum class AverageTimeNumberSamples {
	AVGS_8 = 0x0, AVGS_16 = 0x1, AVGS_32 = 0x2, AVGS_64 = 0x3,
};
...
enum class BatteryMonitorStatus {
	LOW_ENABLED = 0x0, HIGH_ENABLED = 0x1,
};
...
enum class IRQPolarity {
	ACTIVE_HIGH = 0x0, ACTIVE_LOW = 0x1
};
